...
Route::group(['prefix' => 'account', 'namespace' => 'User', 'middleware' => 'check_user_login'], function () {
    ...
    Route::get('ajax-invoice-transaction/{id}', 'UserTransactionController@exportInvoiceTransaction')->name('ajax_get.user.invoice_transaction');

    Route::get('order/success', [App\Http\Controllers\Frontend\ShoppingCartController::class, 'orderSuccess'])->name('order.success');
});
