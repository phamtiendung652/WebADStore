<div style="width: 100%;max-width: 600px;margin:0 auto">
    ...
    <div
        ...
        <p>Bạn có một yêu cầu thay đổi mật khẩu <a href="{{ $link }}">click vào đây</a> để truy cập đường dẫn
            thay đổi mật khẩu.</p>
        <p><i>Chú ý</i> : Đường dẫn sẽ bị xoá sau 3</p>
    </div>
    <div style="background: #f4f5f5;box-sizing: border-box;padding: 15px">
        <p style="margin:2px 0;color: #333">Email : phamtiengdung6524@gmail.com</p>
