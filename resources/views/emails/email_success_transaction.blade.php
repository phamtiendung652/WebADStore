<div style="width: 100%;max-width: 600px;margin:0 auto">
    ...
    <div style="background: white;padding: 15px;border:1px solid #dedede;">
        <h2 style="margin:10px 0;border-bottom: 1px solid #dedede;padding-bottom: 10px;">Danh sách sản phẩm bạn đã mua
        </h2>
        <div>
                    ...
                    <div class="" style="width: 15%;float: left;">
                        <a href="">
                            <img style="max-width: 100%;width: 80px;height: 100px"
                                src="http://tranining.previewcode.net{{ pare_url_file($item->options->image) }}">
                        </a>
                    </div>
                    <div style="width: 80%;float: right;">
                        <h4 style="margin:10px 0">{{ $item->name }}</h4>
                        <p style="margin: 4px 0;font-size: 14px;">Giá <span>{{ number_format($item->price, 0, ',', '.') }}
                                đ</span></p>
    ...
    <div style="background: #f4f5f5;box-sizing: border-box;padding: 15px">
        <p style="margin:2px 0;color: #333">Email : phamtiendung652@gmail.com</p>
        <p style="margin:2px 0;color: #333">Phone : 0933324576</p>
        <p style="margin:2px 0;color: #333">Face : <a href="https://www.facebook.com/pham.dung.734839">DungPham</a></p>
    </div>
</div>
