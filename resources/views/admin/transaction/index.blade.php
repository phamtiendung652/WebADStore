                ...
                <div class="box-title">
                    <form class="form-inline">
                        ...
                        <select name="type" class="form-control">
                            ...
                            <option value="2" {{ Request::get('type') == 2 ? "selected='selected'" : '' }}>Khách
                            </option>
                        </select>
                        <select name="status" class="form-control">
                            ...
                            <option value="3" {{ Request::get('status') == 3 ? "selected='selected'" : '' }}>Đã bàn
                                giao</option>
                            <option value="-1" {{ Request::get('status') == -1 ? "selected='selected'" : '' }}>Huỷ bỏ
                            </option>
                        </select>
                                                            ...
                                                            <li>
                                                                <a
                                                                    href="{{ route('admin.action.transaction', ['process', $transaction->id]) }}"><i
                                                                        class="fa fa-tint"></i> Đang vận chuyển</a>
                                                            </li>
                                                            <li>
                                                                <a
