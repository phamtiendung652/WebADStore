...
{{--                    </div>--}}
                ...
                <div class="form-group ">
                    ...
                    <textarea name="pro_description" id="pro_description" class="form-control textarea" cols="5" rows="2" autocomplete="off">{{  $product->pro_description ?? old('pro_description') }}</textarea>
